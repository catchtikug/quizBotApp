...
ALLOWED_HOSTS = ['quizbotapp.onrender.com', 'quizbotbible.com', 'www.quizbotbible.com', '127.0.0.1']
...
ROOT_URLCONF = 'project_quizz.urls'
...
WSGI_APPLICATION = 'project_quizz.wsgi.application'
...
cloudinary.config( 
  	cloud_name = 'dajpwmuxc',
  	api_key = '315577942282121',
  	api_secret = 'IAB6N9a22LWu0apaw-IX7pgng_8',
    secure=True
)
