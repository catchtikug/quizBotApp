...
class Command(BaseCommand):
    help = 'Import questions for the book of Samuel II from CSV'

    def handle(self, *args, **kwargs):
        csv_file_path = 'samuel_two_questions.csv'

        category, _ = Categories.objects.get_or_create(name="Old Testament")
        book, _ = Books.objects.get_or_create(name="Samuel II", category=category)
        ...
        self.stdout.write(self.style.SUCCESS("✅ Samuel II questions imported successfully."))
