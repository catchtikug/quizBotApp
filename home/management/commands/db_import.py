...
class Command(BaseCommand):
    help = 'Import questions for the book Kings I from CSV'

    def handle(self, *args, **kwargs):
        csv_file_path = 'kings_one_questions.csv'

        category, _ = Categories.objects.get_or_create(name="Old Testament")
        book, _ = Books.objects.get_or_create(name="Kings I", category=category)
        ...
        self.stdout.write(self.style.SUCCESS("✅ Kings I questions imported successfully."))
